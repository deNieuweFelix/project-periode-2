//info van alle games in een multidimensiomale array
const games = [
    {
            titel: 'Balatro',
            sterren: 5,
...
//currentgame (de game die geseecteerd is)
let currentGame = 0;

//maakt de elements makkelijker om te selecteren
...
//laat de knop werken net zoals de vorige scripts
...
//zet de data daadwerkelijk op de pagina
